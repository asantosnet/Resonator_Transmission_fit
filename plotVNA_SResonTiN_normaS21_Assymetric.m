function [ InfoText ] = plotVNA_SResonTiN_normaS21_Assymetric
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here
%   Uses the version compare_FitS21ResonTiN_Assymetric and reads the file that
%   comes from Romain's manip
%   Normalization by dividing the S21 by the one where the transfer switch
%   is off. Taking both real and imaginary parts. 
%
